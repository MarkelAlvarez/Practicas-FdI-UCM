...
public:
	...
	**/
	...
	COMPLEJIDAD: Determinar aquí, justificadamente, la complejidad de esta operación
		...
		Se recorre la cola hasta que encontremos la posicion deseada y se guarda la posicion anterior en aux2 y la posicion actual en aux,
		despues se hace el cambio.
	**/
